        ...
        <div class="footer_top">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xl-4 col-md-6 col-lg-4" align="center">
                        <div class="footer_widget">
                            <!--<h3 class="footer_title">
                                Suscribirse
                            </h3>
                            ...
                            <p class="newsletter_text">Se el primero en recibir nuestras</p>-->
                            <img src="img/logo/logo_white.png" style="width: 150px;">
                        </div>
                    </div>
                </div>
            </div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos los derechos reservados | Secadi Servicios 
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                </div>
